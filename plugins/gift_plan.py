...
async def gift_plan_handler(client: Client, message: Message):
    ...
    if result == "success":
        update_one(user_id, {"gift_used": True})  # بدون await
